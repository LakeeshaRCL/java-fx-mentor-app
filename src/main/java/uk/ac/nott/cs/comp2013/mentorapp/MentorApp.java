...
public class MentorApp extends Application {
    ...
    private AdminView createAdminView(SupportRequestController controller, LoginController loginController) {

        return new AdminView(controller, loginController);
    }


    private MenteeView createMenteeView(LoginController controller, SupportRequestController requestController, SupportSession supportSession) {
        return new MenteeView(controller, requestController, supportSession);
    }
    ...
    public void start(Stage stage) throws Exception {
        ...
        vm.addView(ViewManager.ADMIN, createAdminView(supportRequestController, loginController));
        vm.addView(ViewManager.MENTEE, createMenteeView(loginController, supportRequestController, supportSession));
